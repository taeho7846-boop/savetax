...
import { rejectIncomeTaxReport, getIncomeTaxRejections } from "@/app/actions/income-tax";
...
export function RejectModal({
  ...
  useEffect(() => {
    getIncomeTaxRejections(clientId, taxYear).then((rows) => setHistory(rows as any));
  }, [clientId, taxYear]);
  ...
  async function submit() {
    ...
    setSubmitting(true);
    try {
      await rejectIncomeTaxReport(clientId, taxYear, r);
      onRejected?.();
      onClose();
    } catch (e: any) {
        ...
        <div className="flex-1 overflow-y-auto px-7 py-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="예) 매출액 검토 필요 / 공제 누락 / 신고유형 재확인..."
              rows={5}
