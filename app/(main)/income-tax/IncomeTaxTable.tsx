    ...
    <>
                    ...
                    {list.length === 0 ? (
                      ...
                      return (
                        <tr key={client.id} onClick={() => setSelectedClientId(client.id)}
                          ...
                          {(() => {
                            const unpaid = !r.cmsWithdrawn && !r.directDeposit;
                            const unpaidBg = unpaid ? "bg-[#FEE2E2]/50" : "";
                            return (
                              <>
                                <td className={`px-2 py-2.5 text-center ${unpaidBg}`} onClick={(e) => e.stopPropagation()}>
      ...
      <div className="glass rounded-2xl">
        <table className="w-full text-xs whitespace-nowrap">
          <thead className="sticky top-0 z-30 bg-white/90 backdrop-blur-md shadow-[0_1px_0_0_rgba(0,0,0,0.04)]">
            {/* 그룹 헤더 */}
            <tr>
