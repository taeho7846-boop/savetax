...
export async function createClient(formData: FormData) {
  ...
  const client = await prisma.client.create({
    data: {
      ...
      withdrawalDay: formData.get("withdrawalDay") ? parseInt(formData.get("withdrawalDay") as string) : null,
      billingTiming: (formData.get("billingTiming") as string) || null,
      bankName: (formData.get("bankName") as string) || null,
      bankAccount: (formData.get("bankAccount") as string) || null,
      openDate: (formData.get("openDate") as string) || null,
      contractDate: (formData.get("contractDate") as string) || null,
      bizType: (formData.get("bizType") as string) || null,
