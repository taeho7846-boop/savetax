      ...
      >
        ...
        <div className="flex items-center bg-gray-100 px-2 pt-1 shrink-0 overflow-x-auto">
          ...
          <div className="relative">
            <button onClick={() => setAddMenuOpen(!addMenuOpen)} className="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-gray-700 hover:bg-gray-200 rounded-full ml-1 text-lg">+</button>
            {addMenuOpen && (
              <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-20 py-1 min-w-[140px]">
                <button onClick={() => addTab("business")} className="w-full text-left px-3 py-2 text-sm hover:bg-gray-50">사업소득</button>
                <button onClick={() => addTab("employment")} className="w-full text-left px-3 py-2 text-sm hover:bg-gray-50">근로소득</button>
                <button onClick={() => addTab("other")} className="w-full text-left px-3 py-2 text-sm hover:bg-gray-50">기타소득</button>
              </div>
            )}
          </div>
        </div>
